...
class Config(object):
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = "arn:aws:sns:us-east-1:127134666975:jgoode_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = "arn:aws:sns:us-east-1:127134666975:jgoode_job_results"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "jgoode_annotations"

  # Stripe API keys
  STRIPE_PUBLIC_KEY = "pk_test_71LZOydb2TnP5Z1dszBr4Uyg"
  STRIPE_SECRET_KEY = "sk_test_SryzTRSxH1Yh8AwbFMJqREzs"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "jgoode@ucmpcs.org"
